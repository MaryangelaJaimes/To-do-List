...
let tareas = [
  { id: 1, descripcion: "Estudiar", checked: false },
  { id: 2, descripcion: "Practicar Ingles", checked: false },
  { id: 3, descripcion: "Leer", checked: false },
];
  ...
  for (let tarea of tareas) {
    html += `
        <tr>
            ...
            <td>
                <input type="checkbox" onclick='actualizarTarea(${tarea.id})' ${
      tarea.checked ? "checked" : ""
    }>
            </td>

            <td>
                <button id='eliminar' type='button' onclick="borrar(${
                  tarea.id
